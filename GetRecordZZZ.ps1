...
Write-Host "Mencari URL Signal Search ZZZ..." -ForegroundColor Cyan

$localLowPath = "$env:USERPROFILE\AppData\LocalLow\miHoYo\ZenlessZoneZero"
...
if (-not $gamePath -or -not (Test-Path $gamePath)) {
    $gamePath = "G:\Game\HoYoPlay\games\ZenlessZoneZero Game"
}
...
if (-not $latestCacheFile) {
    ...
    Write-Host "Pastikan menu History Gacha di dalam game SUDAH dibuka!" -ForegroundColor Yellow
